...
import com.example.sportevents.api.inputoutput.logs.sendlogs.SendLogsOutput;
import com.example.sportevents.core.exceptions.logger.InternalLoggerIsEmptyException;
